...
const page =  () => {
  ...
  <div class=" bg-yellow-300 h-full snap-start inline-block w-full">
  <Tablet/>
  </div>
  <div class=" bg-purple-500 h-full snap-start inline-block w-full">Item 5</div>
  <Tablet/>
  <div class=" bg-black h-full snap-start inline-block w-full">
  <Tablet/>
  </div>
  <div class=" bg-zinc-700 h-full snap-start inline-block w-full">
  <Tablet/>
  </div>
  <div class=" bg-blue-400 h-full snap-start inline-block w-full">
  <Tablet/>
  </div>
  <div class=" bg-cyan-900 h-full snap-start inline-block w-full">
  <Tablet/>
  </div>
