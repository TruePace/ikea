    ...
    return (
        ...
        <div class="bg-white w-full fixed bottom-0 left-0 right-0 py-1.5 flex flex-nowrap justify-evenly">
          {links.map((link)=>(
            ...
            <div key={link.title} class={` w-1/4 flex flex-col justify-center items-center ${pathName === link.path && 'w-1/5  border border-red-500 bg-opacity-65 rounded-lg shadow-lg shadow-red-700/50 flex flex-col  py-1   font-semibold'   }`}>
